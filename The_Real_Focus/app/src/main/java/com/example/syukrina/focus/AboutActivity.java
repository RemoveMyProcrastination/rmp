...
/**
 * Created by SYUKRINA on 11/29/2016.
 */
...
public class AboutActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_timelapse) {
            Intent intent = new Intent(AboutActivity.this, HomePage.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.nav_faces) {
            Intent intent = new Intent(AboutActivity.this, FacesActivity.class);
            startActivity(intent);
